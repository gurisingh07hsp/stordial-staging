...
const BusinessDetailByCategoryAndLocation = ({ params }: CategoryPageProps) => {
                  ...
                  <div key={business._id} className="bg-white rounded-lg border p-4">
                    <div className="flex lg:flex-row flex-col items-start justify-between">
                      ...
                      <div className='lg:w-32 w-24 h-[100px] flex justify-center items-center'>
                        <img src={business.images && business.images[0]?.url} alt="" className={`h-full w-full object-cover rounded-lg ${business.images && business.images?.length > 0 ? 'block' : 'hidden'}`} />
...
export default BusinessDetailByCategoryAndLocation
